...
This module provides functions for generating random crystal structures.
"""
...
def random_crystal(dim: int, group: int, species: List[str], num_ions: List[int], **kwargs) -> Crystal:
    """
    ...
    Args:
        ...
        species (List[str]): List of chemical symbols for the atoms in the crystal.
        num_ions (List[int]): List of integers representing the number of ions of each species.
    ...
    try:
        ...
        raise ImportError("The pyxtal package is required to generate random crystals. Install with: pip install pyxtal")
