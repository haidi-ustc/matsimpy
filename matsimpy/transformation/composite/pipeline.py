...
class TransformationPipeline:
    ...
    def apply(self, structure: Union[Crystal, Molecule], 
        ...
        result = self.steps[0]['func'](structure, **self.steps[0]['kwargs'], inplace=inplace)
    ...
    def apply_batch(self, structures: List[Union[Crystal, Molecule]],
                   parallel: bool = False,
                   n_workers: int = 4) -> List[Union[Crystal, Molecule]]:
        """
    ...
    def load(cls, path: Union[str, Path]) -> 'TransformationPipeline':
        ...
        for step_dict in pipeline_dict['steps']:
            ...
            if func_module and func_name:
                ...
                raise ValueError(
                    f"Cannot load step: missing func_module or func_name"
                )
