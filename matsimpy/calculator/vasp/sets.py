...
Original: pymatgen.io.vasp.sets
...
class VaspInputSet(InputGenerator, abc.ABC):
    ...
    def write_input(
        ...
        Args:
            ...
            potcar_spec (bool): Instead of writing the POTCAR, write a "POTCAR.spec".
                ...
                the specific POTCAR file can be reconstructed from a configured
                POTCAR library.
    ...
    def get_input_set(
        ...
        Args:
            ...
            potcar_spec (bool): Instead of generating a Potcar object, use a list of
                ...
                POTCAR file can be reconstructed from a configured POTCAR library.
    ...
    def calculate_ng(
        ...
        if custom_encut is not None:
            ...
            encut = max(i_species.enmax for i_species in self.get_input_set()["POTCAR"])
...
class MVLSlabSet(VaspInputSet):
    ...
    def kpoints_updates(self) -> Kpoints:
        ...
        return Kpoints(
            comment="Generated by MatSimPy MVLGBSet",
