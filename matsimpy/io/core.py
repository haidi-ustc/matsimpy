...
def read(filename: str, format: Optional[str] = None, **kwargs) -> Union[Crystal, Molecule]:
    """
...
def write(structure: Union[Crystal, Molecule, Structure], 
          filename: str, 
