...
def _build_full_heusler(X: str, Y: str, Z: str, a: float) -> Crystal:
    ...
    for coord in base_coordinates:
        ...
        if (x == 0.0 and y == 0.0 and z == 0.0) or \
           (x == 0.5 and y == 0.5 and z == 0.5) or \
           (x == 0.0 and y == 0.5 and z == 0.5) or \
           (x == 0.5 and y == 0.0 and z == 0.5) or \
           (x == 0.5 and y == 0.5 and z == 0.0) or \
           (x == 0.5 and y == 0.0 and z == 0.0) or \
           (x == 0.0 and y == 0.5 and z == 0.0) or \
           (x == 0.0 and y == 0.0 and z == 0.5):
            species.append(X)
        # Y site: (¼,¼,¼) type
        elif (x == 0.25 and y == 0.25 and z == 0.25) or \
             (x == 0.75 and y == 0.75 and z == 0.25) or \
             (x == 0.25 and y == 0.75 and z == 0.75) or \
             (x == 0.75 and y == 0.25 and z == 0.75):
            species.append(Y)
        # Z site: (¾,¾,¾) type
        elif (x == 0.75 and y == 0.75 and z == 0.75) or \
             (x == 0.25 and y == 0.25 and z == 0.75) or \
             (x == 0.75 and y == 0.25 and z == 0.25) or \
             (x == 0.25 and y == 0.75 and z == 0.25):
            species.append(Z)
        else:
...
def build_full_heusler(X: str, Y: str, Z: str, lattice_constant: float, **kwargs) -> Crystal:
    """
...
def build_half_heusler(X: str, Y: str, Z: str, lattice_constant: float, **kwargs) -> Crystal:
    """
...
def build_inverse_heusler(X: str, Y: str, Z: str, lattice_constant: float, **kwargs) -> Crystal:
    """
