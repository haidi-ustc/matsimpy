...
def get_generation_prompt(
    composition: str, constraints: Optional[Dict[str, Any]] = None
) -> str:
    """
...
def get_optimization_prompt(
    property_name: str, target_value: Optional[float] = None, maximize: bool = True
) -> str:
    """
    ...
    if target_value:
        prompt = f"Optimize the structure to achieve {property_name} = {target_value}."
    else:
        prompt = f"Optimize the structure to {direction} {property_name}."
