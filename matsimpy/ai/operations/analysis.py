...
class AIAnalysis(AIOperation):
    ...
    def analyze_structure(
        self, structure: Crystal, analysis_type: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        result = self.interface.call(operation="analyze_structure", inputs=inputs)

        return result.get("analysis", {})

    def suggest_improvements(
        self, structure: Crystal, target_property: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
        ...
        result = self.interface.call(operation="suggest_improvements", inputs=inputs)

        return result.get("suggestions", [])

    def compare_structures(
        self, structures: List[Crystal], comparison_type: str = "properties"
    ) -> Dict[str, Any]:
        """
        ...
        result = self.interface.call(
            ...
            inputs={"structures": structures_data, "comparison_type": comparison_type},
        )
    ...
    def validate_structure(self, structure: Crystal) -> Dict[str, Any]:
        ...
        result = self.interface.call(
            operation="validate_structure", inputs={"structure": structure_data}
        )
